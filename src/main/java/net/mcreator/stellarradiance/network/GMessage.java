...
import net.mcreator.stellarradiance.procedures.Songkai7Procedure;
import net.mcreator.stellarradiance.procedures.Anxia7Procedure;
...
public class GMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Anxia7Procedure.execute(entity);
		}
		if (type == 1) {

			Songkai7Procedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		StellarRadianceMod.addNetworkMessage(GMessage.class, GMessage::buffer, GMessage::new, GMessage::handler);
	}
}
