...
import net.mcreator.stellarradiance.procedures.Songkai5Procedure;
import net.mcreator.stellarradiance.procedures.Anxia5Procedure;
...
public class BMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Anxia5Procedure.execute(entity);
		}
		if (type == 1) {

			Songkai5Procedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		StellarRadianceMod.addNetworkMessage(BMessage.class, BMessage::buffer, BMessage::new, BMessage::handler);
	}
}
