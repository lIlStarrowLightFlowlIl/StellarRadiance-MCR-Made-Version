...
import net.mcreator.stellarradiance.procedures.Songkai2Procedure;
import net.mcreator.stellarradiance.procedures.Anxia2Procedure;
...
public class VMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Anxia2Procedure.execute(entity);
		}
		if (type == 1) {

			Songkai2Procedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		StellarRadianceMod.addNetworkMessage(VMessage.class, VMessage::buffer, VMessage::new, VMessage::handler);
	}
}
