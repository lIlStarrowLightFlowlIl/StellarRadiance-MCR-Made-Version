...
public class Modelstellar_energy_nexus<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("stellar_radiance", "modelstellar_energy_nexus"), "main");
	public final ModelPart Center;
	public final ModelPart Huan;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Center = partdefinition.addOrReplaceChild("Center",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 28).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 15.0F, 0.0F));
		PartDefinition Huan = partdefinition.addOrReplaceChild("Huan", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition Kuai_r1 = Huan.addOrReplaceChild("Kuai_r1", CubeListBuilder.create().texOffs(0, 44).addBox(-13.0F, -2.0F, -13.0F, 26.0F, 4.0F, 26.0F, new CubeDeformation(0.0F)),
