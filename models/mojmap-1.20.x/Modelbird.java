...
public class Modelbird<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition WingB = partdefinition.addOrReplaceChild("WingB", CubeListBuilder.create(),
				PartPose.offset(-1.5F, 16.9F, -2.8F));

		PartDefinition WingB_r1 = WingB.addOrReplaceChild("WingB_r1",
				CubeListBuilder.create().texOffs(9, 6).addBox(-0.5F, -2.5F, -1.5F, 1.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.25F, 0.25F, 1.0F, -0.4897F, 0.8214F, 1.2125F));

		PartDefinition WingA = partdefinition.addOrReplaceChild("WingA", CubeListBuilder.create(),
				PartPose.offset(1.5F, 16.9F, -2.8F));

		PartDefinition WingA_r1 = WingA.addOrReplaceChild("WingA_r1",
				CubeListBuilder.create().texOffs(0, 14).addBox(-0.5F, -2.5F, -1.5F, 1.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.25F, 0.25F, 1.0F, -0.4849F, -0.8705F, -1.2336F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 16.5F, -3.0F, 0.4363F, 0.0F, 0.0F));

		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(15, 12)
						.addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 14)
						.addBox(-1.0F, -2.25F, -2.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(17, 6)
						.addBox(-0.5F, -1.5F, -3.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 18)
						.addBox(-0.5F, -1.0F, -3.9F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 5)
						.addBox(0.0F, -4.95F, -1.6F, 0.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(17, 10)
						.addBox(-0.75F, -1.75F, -1.9F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 6)
		...
		PartDefinition Tail = partdefinition
				.addOrReplaceChild("Tail",
						CubeListBuilder.create().texOffs(12, 0).addBox(-1.5F, -1.0F, -1.0F, 3.0F, 5.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 21.1F, 1.2F, 0.8727F, 0.0F, 0.0F));

		PartDefinition LegA = partdefinition.addOrReplaceChild("LegA",
				CubeListBuilder.create().texOffs(17, 17).addBox(-1.0F, -0.75F, -1.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, 23.0F, -0.5F, 0.2182F, 0.0F, 0.0F));

		PartDefinition LegB = partdefinition.addOrReplaceChild("LegB",
				CubeListBuilder.create().texOffs(5, 14).addBox(-1.0F, -0.5F, -1.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
